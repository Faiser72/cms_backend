...
public class JwtTokenUtil implements Serializable {
	...
	public Boolean validateToken(String token, UserDetails userDetails) {
		...
		final String authorityRole = userDetails.getAuthorities().stream().map(GrantedAuthority::getAuthority)
				.collect(Collectors.joining());
		return (username.equals(userDetails.getUsername()) && role.equals(authorityRole) && !isTokenExpired(token));
	}
}
